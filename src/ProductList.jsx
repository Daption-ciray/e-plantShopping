...
function ProductList({ onHomeClick }) {
    ...
    const handleAddToCart = (plant) => {
        // Mark as added for UI feedback
        setAddedToCart((prev) => ({
            ...prev,
            [plant.name]: true,
        }));
        // Dispatch to cart slice with initial quantity
                    ...
                    <div className="luxury">
                        ...
                        <a href="/" onClick={(e) => handleHomeClick(e)}>
                            <div>
                                ...
                                <i style={{ color: 'white' }}>Where Green Meets Serenity</i>t
                            </div>
                        </a>
                    </div>
                    ...
                    <div>
                        <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                            <h1 className='cart' style={{ position: 'relative', display: 'inline-block' }}>
                                ...
                                {totalCartQuantity > 0 && (
                                    <span style={{ position: 'absolute', top: '-6px', right: '-6px', background: 'red', color: 'white', borderRadius: '50%', minWidth: '22px', height: '22px', lineHeight: '22px', fontSize: '12px', textAlign: 'center', padding: '0 6px' }}>{totalCartQuantity}</span>
                                )}
                            </h1>
                        </a>
                    </div>
